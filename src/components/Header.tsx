  ...
  return (
    <div className="bg-main-3 text-white py-6 px-6 flex justify-between items-center">
      <div className="flex items-center gap-4">
        <img src="assets/Logo.png" alt="Logo" className="w-25 rounded-[100px]"/>
      ...
      <SearchBar id="SearchHeader" placeholder="Buscar" width={70} actionSearch={(text) => console.log(text)}></SearchBar>
    </div>
  )
}
